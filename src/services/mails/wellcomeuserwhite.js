...
const wellcomeuserwhite = async (name,email) => {
    ...
    var contenido  = "<p>Nos complace mucho que haya descargado nuestra App y se haya inscrito, en ella podrá encontrar todas las unidades de negocio de nuestros afiliados (Fabricantes, Mayoristas y Distribuidores del sector de consumo masivo) que le pueden atender en su establecimiento, solo tiene que solicitar la atención (codificación) del proveedor de su interés, y ellos estaran poniéndose en contacto para establecer las mejores condiciones de servicio. Una vez este registrado con todos los datos de su negocio, la App le permitirá conocer todo su portafolio de productos y hacerle los pedidos que requiera para su negocio, desde cualquier lugar y momento. </p>";
        ...
        contenido += "<p>Es importante que emplee la misma cuenta de correo que haya empleado en la App <strong>Pide & Surte</strong>, ya que eso nos permitirá poderlo atender sin una nueva codificación de su establecimiento.";
        contenido += "<p>Nuestro comercial, le ayudara a conocer la App y hacer el mejor uso de ella, guardaremos los productos que típicamente nos compra en un concepto que hemos llamado “Mi Lista” para que la próxima vez que su surtido requiera renovación, ya no tenga que ir a buscar los productos, solo coloca la cantidad y poner el pedido. Estamos para seguir ayudándole y mejorando, cuéntenos como le parece este nuevo servicio.";
